            ...
            <div class="d-flex justify-content-between">
                <div class="top-info ps-2">
                    <small class="me-3"><i class="fas fa-map-marker-alt me-2 text-secondary"></i> <a href="#"
                            class="text-white">Churu-Jhunjhunu By Pass, Bissau,jhunjhunu</a></small>
                    <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#"
                            class="text-white">1991rakeshsaini@gmail.com</a></small>
                </div>
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    ...
                    <div class="d-flex m-3 me-0">
                        ...
                        @if (Auth::check())
                            ...
                            <div class="btn-group">
                                <button type="button" style="background-color:  #81c408"
                        ...
                        @else
                            ...
                            <a href="{{ route('login') }}">
                                <button type="button" class="btn btn-success" style="background-color:  #81c408">
                                    Sign In
                                </button>
                            </a>
                        @endif
